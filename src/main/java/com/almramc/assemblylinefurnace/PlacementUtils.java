...
public class PlacementUtils {
	...
	private static List<Material> burnables = Arrays.asList(Material.CLAY, Material.IRON_ORE, Material.GOLD_ORE, Material.SAND, Material.COBBLESTONE, Material.PORK, Material.CLAY_BALL, Material.getMaterial(17), Material.CACTUS, Material.DIAMOND_ORE, Material.RAW_FISH, Material.RAW_BEEF, Material.RAW_CHICKEN, Material.POTATO_ITEM, Material.QUARTZ_ORE, Material.FLINT, Material.ROTTEN_FLESH, Material.getMaterial("ALMURA_INGREDIENTSROASTBEEF_RAW"), Material.getMaterial("ALMURA_INGREDIENTSLAMBCHOP_RAW"), Material.getMaterial("ALMURA_INGREDIENTSCHICKENLEG_RAW"), Material.getMaterial("MILK_BUCKET"), Material.DIAMOND_ORE, Material.REDSTONE_ORE, Material.LAPIS_ORE, Material.COAL_ORE, Material.getMaterial("ALMURA_ORESMARBLEORE"), Material.getMaterial("ALMUAR_INGREDIENTSPORKBELLY_RAW")); 
